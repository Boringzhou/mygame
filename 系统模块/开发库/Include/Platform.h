...
//平台常量
const TCHAR szProduct[]=TEXT("天天乐棋牌");							//产品名字
const TCHAR szPlazaClass[]=TEXT("WHZJZHQPGamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("WHZJZHQPGamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://");					//记录地址
const TCHAR szLogonServer[]=TEXT("www.gamettle.com");						//登录地址
...
const TCHAR szLogonServer[]=TEXT("jd.foxuc.net");						//登录地址
