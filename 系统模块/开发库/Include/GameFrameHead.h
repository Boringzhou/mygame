...
//链接代码
#if (!defined(GAME_FRAME_DLL) && defined(SDK_COMPATIBLE)) 	
...
#ifndef _DEBUG
#ifndef _UNICODE
#pragma comment (lib,"../../../../系统模块/链接库/Ansi/FGuilib.lib")
#pragma comment (lib,"../../../../系统模块/链接库/Ansi/FGuimfcFactory.lib")
#else
#pragma comment (lib,"../../../../系统模块/链接库/Unicode/FGuilib.lib")
#pragma comment (lib,"../../../../系统模块/链接库/Unicode/FGuimfcFactory.lib")
#endif
#else
#ifndef _UNICODE
#pragma comment (lib,"../../../../系统模块/链接库/Ansi/FGuilibD.lib")
#pragma comment (lib,"../../../../系统模块/链接库/Ansi/FGuimfcFactoryD.lib")
#else
#pragma comment (lib,"../../../../系统模块/链接库/Unicode/FGuilibD.lib")
#pragma comment (lib,"../../../../系统模块/链接库/Unicode/FGuimfcFactoryD.lib")
#endif
#endif
#endif
...
#ifdef _UNICODE
#define VER_IClientCompilationSink INTERFACE_VERSION(1,1)
static const GUID IID_IClientCompilationSink={0x133BFAEB,0xB7E3,0x4F18,0xAE,0xDF,0x51,0x6A,0xBA,0x26,0xD7,0x88};
#else
#define VER_IClientCompilationSink INTERFACE_VERSION(1,1)
static const GUID IID_IClientCompilationSink={0x1761E059,0x67DA,0x46E8,0xAD,0x97,0xCA,0x56,0x43,0xE6,0xF8,0xE2};
#endif

//内核回调
interface IClientCompilationSink : public IUnknownEx
{
	//获取信息
public:
	//获取信息
...
public:
	//渲染视图
	virtual VOID RenderGameView()=NULL;
};
