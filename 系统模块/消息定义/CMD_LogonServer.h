...
#define SUB_GP_USER_CHOUJIANG			104								//用户抽奖
#define SUB_GP_QUERY_ROOM_LIST			105								//房间列表
#define SUB_GP_QUERY_ACCOUNTINFO		304								//个人信息


////////////////////2017-02-20 洪//////////////////////////////
//自定义服务
#define SUB_GP_QUERY_INGAME_SEVERID		110								//游戏状态
#define SUB_GP_GAME_RECORD_LIST			111								//游戏记录
#define SUB_GP_GAME_RECORD_TOTAL		112								//游戏记录
///////////////////////////////////////////////////////////////
...
#define SUB_GP_SIMPLE_LOTERY			345								//简单抽奖
#define SUB_GP_SIMPLE_LOTTERY_RESULT	346								//抽奖结果
#define SUB_GP_LOTTERY_NOTI				347								//抽奖通知

//游戏服务
#define SUB_GP_QUERY_USER_GAME_DATA		360								//查询数据	

//信息获取
#define SUB_GP_QUERY_SYSTEMQQ			370								//游戏客服:DCY by 2017.3.9
#define SUB_GP_QUERY_SYSTEMINFO			371								//系统公告:DCY by 2017.3.9
#define SUB_GP_QUERY_SYSTEMCONTACT		372								//联系我们:DCY by 2017.3.9
#define SUB_GP_QUERY_SHOP				373								//游戏商城:DCY by 2017.3.11
#define SUB_GP_EXCHANGE_SHOP			374								//兑换商品:DCY by 2017.3.11
...
{
	TCHAR							szSystemContact[0xFF];				//联系我们
};
