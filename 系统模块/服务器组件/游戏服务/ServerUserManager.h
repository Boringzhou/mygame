...
public:
	...
	virtual DWORD GetUserJudging() { return m_dwJudging; }
...
public:
	...
	//报名状态
	virtual VOID SetSignUpStatus(BYTE cbSignUpStatus);
...
public:
	...
	//写入积分
    virtual bool WriteUserScore(SCORE lScore, SCORE lGrade, SCORE lRevenue, SCORE lIngot, BYTE cbScoreType, DWORD dwPlayTimeCount,DWORD dwWinExperience,DWORD dwInsure = 0);
	//领取奖励
