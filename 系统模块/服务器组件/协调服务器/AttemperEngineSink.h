...
protected:
	...
	//房间服务
	bool OnTCPNetworkMainRoomService(WORD wSubCmdID, VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//辅助函数
protected:
	//发送列表
	...
	//查询房间列表
	bool QueryRoomList(DWORD dwSocketID,DWORD dwUserID,DWORD dwClientSocketID);
