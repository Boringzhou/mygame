...
public:
	...
	//插入参数
	VOID AddParameter(LPCTSTR pszItem, LPCTSTR pszString, ParameterDirectionEnum ParameterDirection=adParamInput);
	//插入参数
	VOID AddParameter(LPCTSTR pszItem, SYSTEMTIME & SystemTime, ParameterDirectionEnum ParameterDirection=adParamInput);
	//插入参数
	VOID AddParameterOutput(LPCTSTR pszItem, LPCTSTR pszString, UINT uSize, ParameterDirectionEnum ParameterDirection=adParamInputOutput);
