...
public:
	//应答事件
	virtual bool  OnEventTCPNetworkBind(DWORD dwSocketID, DWORD dwClientIP);
	//关闭事件
	virtual bool  OnEventTCPNetworkShut(DWORD dwSocketID, DWORD dwClientIP, DWORD dwActiveTime);
	//读取事件
