...
//比赛命令
#define DBR_GP_MATCH_SIGNUP			50									//比赛报名
#define DBR_GP_MATCH_UNSIGNUP		51									//取消报名
...
#define DBR_GP_SIMPLE_LOTTERY		142									//简单抽奖

//游戏服务
#define DBR_GP_QUERY_USER_GAME_DATA	150									//游戏数据

//系统信息
#define DBR_GP_QUERY_SYSTEM_QQ		160									//查询客服:DCY by 2017.3.9
#define DBR_GP_QUERY_SYSTEM_INFO	161									//查询系统公告:DCY by 2017.3.9
#define DBR_GP_QUERY_SYSTEM_CONTACT	162									//查询联系我们:DCY by 2017.3.9
#define DBR_GP_QUERY_SYSTEM_SHOP	163									//查询游戏商城:DCY by 2017.3.11
#define DBR_GP_EXCHANGE_GAME_SHOP	164									//兑换游戏商品:DCY by 2017.3.11
...
struct DBR_GP_ExchangeGameShop
{
	...
	DWORD							dwCount;							//兑换数量
	SCORE							llNumber;							//电话号码
	TCHAR							strName[32];						//收件人名
	TCHAR							strAddress[0x7F];					//收货地址
};
...
{
	LONGLONG					    lLottery;							//中奖
	DWORD							dwUserID;							//用户标识
	DWORD							dwIndex;
	char							szName[LEN_NICKNAME];				//用户昵称
...
#define DBO_GP_USER_INGAME_SERVER_ID   125								//用户游戏状态
...
//兑换命令
#define DBO_GP_MEMBER_PARAMETER     210									//会员参数
#define DBO_GP_PURCHASE_RESULT		211									//购买结果
#define DBO_GP_EXCHANGE_RESULT		212									//兑换结果

//报名结果
#define DBO_GP_MATCH_SIGNUP_RESULT	220									//报名结果
...
#define DBO_GP_SIMPLE_LOTTERY_RESULT		233									//抽奖结果
...
//系统信息结果
#define DBO_GP_SYSTEM_QQ			810									//系统QQ:DCY by 2017.3.9
#define DBO_GP_SYSTEM_INFO			811									//系统公告:DCY by 2017.3.9
#define DBO_GP_SYSTEM_CONTACT		812									//联系我们
#define DBO_GP_SYSTEM_SHOP			813									//游戏商城:DCY by 2017.3.11
#define DBO_GP_EXCHANGE_SHOP		814									//兑换商品:DCY by 2017.3.11
...
{
	TCHAR							szSystemQQ[0xFF];				//系统公告
};

//系统公告结果
struct DBO_GP_SystemInfo
{
	TCHAR							szSystemInfo[0xFF];					//系统公告
};

//系统公告结果
struct DBO_GP_SystemContact
{
	TCHAR							szSystemContact[0xFF];				//系统公告
};
