...
#define COLOR_NORMAL_BK				RGB(21,6,0)							//背景颜色
...
struct tagColorUserList
{
	...
	COLORREF						crAndroidTX;						//字体颜色
	COLORREF						crAndroidBK;						//背景颜色
};
...
protected:
	...
	static CImageList				m_ImageListStatus;					//状态位图
	static CPngImage				m_ImageUserStatus;					//状态图片
