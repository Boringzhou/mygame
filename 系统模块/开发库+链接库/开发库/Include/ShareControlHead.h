...
{
	//播放完成
	virtual VOID OnEventFlashFinish()=NULL;
};
...
public:
	...
	//用户喇叭
	virtual bool InsertUserTrumpet(LPCTSTR pszSendUser,LPCTSTR pszString,COLORREF crColor)=NULL;
	//用户喇叭
	virtual bool InsertUserTyphon(LPCTSTR pszSendUser,LPCTSTR pszString,COLORREF crColor)=NULL;
