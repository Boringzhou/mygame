...
//名片定义
#define NAME_CARD_CY				100									//名片高度
#define NAME_CARD_CX				350									//名片宽度
...
public:
	...
	//道具包裹
	virtual tagPropertyPackage * GetPropertyPackage()=NULL;
...
public:
	...
	//魅力数值
	virtual LONG GetUserLoveLiness()=NULL;
...
public:
	//用户元宝
	virtual SCORE GetUserIngot()=NULL;
	//积分数值
...
interface IUserManagerSink : public IUnknownEx
{
	...
	//用户更新
	virtual VOID OnUserItemUpdate(IClientUserItem * pIClientUserItem, tagUserAttrib & UserAttrib)=NULL;
};
...
public:
	...
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo,tagCustomFaceInfo & CustomFaceInfo,bool bIsAndroid)=NULL;

	//更新接口
public:
	//更新积分
	virtual bool UpdateUserItemScore(IClientUserItem * pIClientUserItem, tagUserScore * pUserScore)=NULL;
	//更新状态
	virtual bool UpdateUserItemStatus(IClientUserItem * pIClientUserItem, tagUserStatus * pUserStatus)=NULL;
	//更新属性
	virtual bool UpdateUserItemAttrib(IClientUserItem * pIClientUserItem, tagUserAttrib * pUserAttrib)=NULL;
	//更新头像
...
public:
	//获得人数
	virtual DWORD GetActiveUserCount()=NULL;
};
...
public:
	...
	virtual bool DeleteUserItem(IClientUserItem * pIClientUserItem)=NULL;
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, BYTE cbCompanion, LPCTSTR pszUserNote,bool bIsAndroid)=NULL;
